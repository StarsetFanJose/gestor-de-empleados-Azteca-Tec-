 ...
 * @author josea
 */
public class ArchivoUtilReportesClientes {
    private final String rutaGuardados = "reportesGuardadosGestor2//reportesClienteGuardados.txt";
    private final String carpetaReportes = "reportesGestor2//ReportesClientes/";
